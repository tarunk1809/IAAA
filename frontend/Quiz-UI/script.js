const questions = [
  { question: "1. What is the capital of France?", options: ["Paris", "London", "Berlin", "Madrid"], correct: 0 },
  { question: "2. Which planet is known as the Red Planet?", options: ["Earth", "Mars", "Jupiter", "Saturn"], correct: 1 },
  { question: "3. What is the largest planet in our solar system?", options: ["Earth", "Mars", "Jupiter", "Saturn"], correct: 2 },
  { question: "4. Which planet is closest to the Sun?", options: ["Mercury", "Venus", "Earth", "Mars"], correct: 0 },
  { question: "5. Which planet is known for its prominent ring system?", options: ["Jupiter", "Saturn", "Uranus", "Neptune"], correct: 1 },
  { question: "6. Which planet is known as the 'Morning Star' or 'Evening Star'?", options: ["Venus", "Mars", "Mercury", "Jupiter"], correct: 0 },
  { question: "7. Which planet has the tallest volcano in the solar system?", options: ["Mars", "Venus", "Earth", "Mercury"], correct: 0 },
  { question: "8. Which planet is known for having a Great Red Spot?", options: ["Mars", "Jupiter", "Saturn", "Uranus"], correct: 1 },
  { question: "9. Which planet is famous for its blue color due to methane in its atmosphere?", options: ["Neptune", "Uranus", "Saturn", "Jupiter"], correct: 0 },
  { question: "10. Which planet is known for having a day that is longer than its year?", options: ["Venus", "Earth", "Mars", "Jupiter"], correct: 0 },
  { question: "11. Which planet has the most moons?", options: ["Saturn", "Jupiter", "Uranus", "Neptune"], correct: 1 },
  { question: "12. Which planet is named after the Roman god of the sea?", options: ["Uranus", "Neptune", "Saturn", "Jupiter"], correct: 1 }
];
